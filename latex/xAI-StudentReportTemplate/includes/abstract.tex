\begin{abstract}
 ...
 These findings indicate that ensemble robustness is constrained both by expert diversity and by the ability of routing mechanisms to effectively leverage that diversity. Our publicly accessible repository is available on GitHub.\footnote{\url{https://github.com/deadPixelsGreta/xAI-proj-m-ws2526.} (accessed February 12, 2026).}
\end{abstract}
